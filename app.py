...
def form():
    if request.method == 'POST':
        ...
        # ô người dùng nhập nơi cất cánh
        ...
        return render_template(
            'form.html',
            predictions=f'Tổng tiền của bạn là {output}'
        )
